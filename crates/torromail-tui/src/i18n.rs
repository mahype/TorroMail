...
const GERMAN: &[(&str, &str)] = &[
    ...
    ("Connecting from here follows once keys can be stored on this platform.", "Das Verbinden von hier aus folgt, sobald Schlüssel auf dieser Plattform gespeichert werden können."),
