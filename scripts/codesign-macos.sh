#!/usr/bin/env bash
# Signs dist/TorroMail.app with a Developer ID certificate, submits it to
...
entitlements="apps/TorroMailApp/Resources/TorroMail.entitlements"
notarize_zip="dist/TorroMail-notarize.zip"
